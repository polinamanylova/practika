...
about_game_button.setIcon(QIcon('UI/MainMenu/elements/settings_button.png'))
about_game_button.setIconSize(QSize(129, 112)) #размер шестеренки
about_game_button.setStyleSheet('''
                                background: #010101;
                                font-size:25px;
                                color: white;
                                border-radius: 50px;
                                ''')  #значения текста об игре

next_button = QToolButton()
next_button.clicked.connect(exit)
next_button.setIcon(QIcon('UI/MainMenu/elements/exit.png'))
